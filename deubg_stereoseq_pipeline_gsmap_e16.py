...
class PipelineConfig:
    ...
    # Base paths
    workdir: str | Path = "/mnt/d/01_Project/01_Research/202312_gsMap/experiment/20250807_refactor_for_gsmap3d/02_latent2gene_optmization_max_pooling/02_mouse_E16"
    data_root: str = "/mnt/d/01_Project/01_Research/202312_gsMap/data/gsMap_dev_data/online_resource/gsMap_example_data/ST"
    gsMap_resource_dir: str = "/mnt/d/01_Project/01_Research/202312_gsMap/data/gsMap_dev_data/online_resource/gsMap_resource"
...
def step1_find_latent_representations(config: PipelineConfig):
    ...
    latent_config = FindLatentRepresentationsConfig(
        h5ad_path=[Path('/mnt/d/01_Project/01_Research/202312_gsMap/data/gsMap_dev_data/online_resource/gsMap_example_data/ST/E16.5_E1S1.MOSTA.h5ad')],
